        ...
        <Sheet.SheetContent side="right" className="w-[85vw] max-w-[350px] p-0 rounded-l-2xl border-l-0 bg-[#F5EFE0]/90 dark:bg-background backdrop-blur-sm dark:backdrop-blur-none">
          <div className="flex flex-col h-full">
            ...
            <div className="border-t border-brand-primary/10 dark:border-gray-800/50 p-4 space-y-4">
              {/* Theme Toggle */}
              <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-[#F5EFE0] dark:bg-gray-800/20 hover:bg-[#F5EFE0]/70 dark:hover:bg-gray-800/40 transition-colors border border-brand-primary/10 dark:border-brand-primary/20">
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Theme</span>
                <Button 
                  variant="ghost" 
                  size="icon" 
                  onClick={toggleTheme} 
                  className="rounded-full h-8 w-8 bg-white dark:bg-gray-800 border border-brand-primary/20 dark:border-brand-primary/30 hover:shadow-md transition-all duration-300"
