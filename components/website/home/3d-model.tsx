  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="w-full h-[900px] overflow-visible relative"
        style={{ zIndex: 999 }}
      >
        {scriptLoaded ? (
          <div
            className="w-full h-full overflow-visible absolute top-0 left-0 right-0 bottom-0"
            style={{ zIndex: 999 }}
            dangerouslySetInnerHTML={{
              __html: `
                <model-viewer
                  ...
                  disable-tap="true"
                  style="width: 100%; height: 100%; background-color: transparent; --poster-color: transparent; position: absolute; top: -40px; left: 0; right: 0; bottom: -350px; z-index: 999; transform: scale(0.65) translateY(-100px);"
                ></model-viewer>
              `,
            }}
          />
