          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredIndustries.map((industry) => (
                <Card key={industry.id} className="overflow-hidden transition-all hover:shadow-md">
                  {/* Image Section */}
                  <div className="relative h-[180px] w-full overflow-hidden bg-muted">
                    {industry.image_url ? (
                      ...
                      <div className="flex h-full w-full items-center justify-center bg-muted">
                        <Factory className="h-16 w-16 text-muted-foreground/40" />
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-4 border-b">
                    <div className="mb-2">
                      <h3 className="font-medium line-clamp-1">{industry.industry_name}</h3>
                    </div>
